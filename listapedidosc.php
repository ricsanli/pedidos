...
<body>
  ...
  <div class="container mt-2 p-5">
    ...
    <div class="row text-center" style="background-color: #cecece">
      <div class="col-md-6">
        <strong>Consultar Pedidos por CLiente  Rango de Fechas</strong>
      </div>
      <div class="col-md-6">
        <strong>Lista de Pedidos/Cliente</strong>
                  ...
                  <div class="col-sm-7">
                    <div class="row" id="lismovped" action='listmovped'>
                      ...
                      if (!empty($_POST['fechaini'])) {
                       ...
                       header("Location: mostrarpedidofechas2.php?fechaini=$fechaini&fechafin=$fechafin");
                       exit();
                      }
                    }
                      ?>
