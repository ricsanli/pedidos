...
<body>
  ...
  <div class="container mt-2 p-5">
    ...
    <div class="row text-center" style="background-color: #cecece">
      <div class="col-md-6">
        <strong>Consultar Productos Pedidos por Rango de Fechas</strong>
      </div>
      <div class="col-md-6">
        <strong>Lista de Productos/Pedidos</strong>
                    ...
                    <div class="row" id="lismovped" action='listmovped'>
                      ...
                      if (!empty($_POST['fechaini'])) {
                       ...
                       // $funciones->listped($cedula, $fechaini, $fechafin);
                         header("Location: mostrarproductosfechas.php?fechaini=$fechaini&fechafin=$fechafin");
                         exit();
                      }
                    }
                      ?>
