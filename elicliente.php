...
<div class="row text-center" style="background-color: #cecece">
  <div class="col-md-6"> 
    <strong>Eliminar Datos Cliente</strong>
  </div>
            ...
            <?php
             include('eliminarcliente.php');
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                    <label for="name" class="form-label">Nombre del Cliente: <?= $datos->name ?> </label>
                    <!-- <input type="text" class="form-control" name="nombre" id="nombre" value="<?= $datos->name ?>"> -->
                </div>
                <div class="col-md-12 mt-2">
                    <label for="" class="form-label">Direccion: <?= $datos->address ?> </label>
                   <!-- <input type="text" class="form-control" name="correo" id="correo" required='true' value="<?= $datos->address ?>"> -->
                </div>
                <div class="col-md-12 mt-2">
                    <label for="celular" class="form-label">Celular: <?= $datos->mobile ?> </label>
                ...
                <div class="row justify-content-start text-center mt-5">
                    <div class="col-12">
                        <button class="btn btn-primary btn-block" value="Eliminar Datos del Cliente " name ="btneliminar" id="btneliminar" >
